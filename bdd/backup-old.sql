...
SELECT pg_catalog.setval('public.canals_cid_seq', 11, true);
...
SELECT pg_catalog.setval('public.tokens_seq', 751, true);
...
ALTER TABLE ONLY public.canals
    ADD CONSTRAINT canals_users_uid_fk FOREIGN KEY (creator_id) REFERENCES public.users(uid) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.tokens
    ADD CONSTRAINT fk2dylsfo39lgjyqml2tbe0b0ss FOREIGN KEY (user_id) REFERENCES public.users(uid);
...
ALTER TABLE ONLY public.invitations
    ADD CONSTRAINT fk88f0ea4w8fhwtsy1tkc0sl1xp FOREIGN KEY (invitee_id) REFERENCES public.users(uid);
...
ALTER TABLE ONLY public.invitations
    ADD CONSTRAINT fkc93ihvftpd11j547qgc9fobmc FOREIGN KEY (inviter_id) REFERENCES public.users(uid);
...
ALTER TABLE ONLY public.user_roles
    ADD CONSTRAINT fkhfh9dx7w3ubf1co1vdev94g3f FOREIGN KEY (user_id) REFERENCES public.users(uid);
...
ALTER TABLE ONLY public.users_invitations
    ADD CONSTRAINT fkjwj4a3s3y08tbcq98m3xlngtx FOREIGN KEY (canal_id) REFERENCES public.canals(cid);
...
ALTER TABLE ONLY public.invitations
    ADD CONSTRAINT fkn2v7dofguhgm8psv9450xgias FOREIGN KEY (canal_id) REFERENCES public.canals(cid);
