...
CREATE TABLE public.invitations (
    ...
    inviter_id integer,
    CONSTRAINT invitations_status_check CHECK (((status)::text = ANY ((ARRAY['PENDING'::character varying, 'ACCEPTED'::character varying, 'DECLINED'::character varying, 'LEAVED'::character varying])::text[])))
);
...
--
-- Name: user_password_reset; Type: TABLE; Schema: public; Owner: sr03
--
...
ALTER TABLE public.user_password_reset OWNER TO sr03;

--
-- Name: user_password_reset_seq; Type: SEQUENCE; Schema: public; Owner: sr03
--

CREATE SEQUENCE public.user_password_reset_seq
    START WITH 1
    INCREMENT BY 50
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE public.user_password_reset_seq OWNER TO sr03;
...
--
-- Data for Name: user_password_reset; Type: TABLE DATA; Schema: public; Owner: sr03
--

COPY public.user_password_reset (id, expiration_date, generation_date, token, user_id) FROM stdin;
\.
...
--
-- Name: user_password_reset user_password_reset_pkey; Type: CONSTRAINT; Schema: public; Owner: sr03
--
...
ALTER TABLE ONLY public.invitations
    ADD CONSTRAINT fk88f0ea4w8fhwtsy1tkc0sl1xp FOREIGN KEY (invitee_id) REFERENCES public.users(uid) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE ONLY public.invitations
    ADD CONSTRAINT fkc93ihvftpd11j547qgc9fobmc FOREIGN KEY (inviter_id) REFERENCES public.users(uid) ON UPDATE SET NULL ON DELETE SET NULL;


--
-- Name: user_password_reset fkdfdix594pcdd3jwd227s123gr; Type: FK CONSTRAINT; Schema: public; Owner: sr03
--

ALTER TABLE ONLY public.user_password_reset
    ADD CONSTRAINT fkdfdix594pcdd3jwd227s123gr FOREIGN KEY (user_id) REFERENCES public.users(uid);
